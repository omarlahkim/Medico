                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="input" placeholder="Prenom">
                        </div>
                        <div class="mb-4">
                            <label class="form-label">Profession</label>
                            <input type="text" class="form-control" name="input" placeholder="Profession">
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="input" placeholder="Nom">
                        </div>
                        <div class="mb-4">
                            <label class="form-label">Assurance</label>
                            <select name="Assurance" id="select-countries" class="form-control custom-select">
                                <option value="br"
                                    data-data="{&quot;image&quot;: &quot;../../assets/images/flags/br.svg&quot;}">Brazil
                                </option>
                                <option value="cz"
                                    data-data="{&quot;image&quot;: &quot;../../assets/images/flags/cz.svg&quot;}">Czech
                                    Republic
                                </option>
                                <option value="de"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="Ville" id="select-countries" class="form-control custom-select">
                                <option value="br"
                                    data-data="{&quot;image&quot;: &quot;../../assets/images/flags/br.svg&quot;}">Brazil
                                </option>
                                <option value="cz"
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" rows="1" placeholder="Adresse"></textarea>
                    </div>
                    <div class="col-md-12">
